...
{
    if (indexPath.row == 0) {
        Level_three_itemOneViewController * oneViewController = [[Level_three_itemOneViewController alloc] init];
        [self.navigationController pushViewController:oneViewController animated:YES];
    } else if (indexPath.row == 1) {
        Level_three_itemTwoViewController * twoViewController = [[Level_three_itemTwoViewController alloc] init];
